package com.allknu.backend.auth.presentation;

import com.allknu.backend.auth.application.AuthService;
...
import com.allknu.backend.global.exception.errors.KnuReadTimeOutException;
